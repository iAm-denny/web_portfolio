...
$total=($page-1)*9;
$sql="SELECT * FROM newanime limit  $total,09";
...
?>
	...
	<div class="contanier nsrh_main">
		
			<div align="center" id="nsrh_bar">
				<input type="text" name="" id="nsearch" placeholder="Search">

					<div id="nsrh-btn">
						<span id="nsrh2"><i class="fas fa-times nsrh2"></i></span>
						<span id="nsrh1"><i class="fas fa-search nsrh1"></i></span>
					</div>
					
			</div>
			<div class="nsearch_list"></div>
	</div>
	...
	while ($row=mysqli_fetch_assoc($result)) {
		...
		$type=$row['type'];
			...
			<div class="col-lg-3 mb-5" align="center">
				<a href="newaniabout.php?newid=<?php echo $id?>" class="aniabout" target="_blank">
  				<img src="admin/newanimes/images/<?php echo $img?>" width="220px" height="300px"><br>
  				<h4><?php echo $name?></h4>
  				<div id="line"></div>
