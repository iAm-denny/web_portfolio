	...
	<div class="container-fluid">
		...
		<div class="container col-lg-6">
			...
			<form action="data.php?up_id=<?php echo $id?>" method="POST" class="mt-5 pt-5" enctype= "multipart/form-data">
				...
				<h6 class="text-info">Your Old Image source is &nbsp &nbsp <b>"denny3/admin/popularanime/images/<?php echo $img?>"</b> </h6>
				<h6 class="text-danger">You need to add image again</h6>
					...
					<input type="submit" class="btn btn-info" value="Update" name="pupdate">
			</form>
		</div>
