			...
			<div class="col-lg-5 mt-5 pt-3">
				...
				<div >
					...
					<form action="contact/contact.php" id="footer_form" class="mb-3" method="POST">
						...
						<input type="email" name="f_email" placeholder ="Email" class="f_email" required>
						<input type="text" name="f_msg" placeholder ="Message" class="f_msg" required>

						<!--<input type="hidden" name="subject" name="denanime">-->
						
						<input type="submit" name="send" value="Send" class="f_send">
					</form>
				</div>
